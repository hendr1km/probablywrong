...
description: 'Plotting correlations as networks can give you a good first impression of the interconnectivity of your variables. This is a quick tutorial on how to create correlation networks in R.'
execute: 
  freeze: auto
  message: false
  warning: false
